...
public interface ConsultaRepositorio extends CrudRepository<Consulta, Long> {
	...
	@Query("SELECT c FROM Consulta c JOIN c.medicos m WHERE c.informacaoConsulta.nomePaciente = :nomePaciente "
	...
	public List<Consulta> findUsingFilter(String crm, LocalDateTime data, String nomePaciente, String especialidade,Integer numeroConsultorio);
